...
- A Plex authentication token. See [Authentication](/guides/authentication/) if you do not have one.
...
- Read the full [Authentication guide](/guides/authentication/) to understand token types and security.
